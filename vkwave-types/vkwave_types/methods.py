...
def account_get_counters(filter: typing.List[str],) -> AccountGetCountersResponse:
    """
...
def account_get_info(fields: typing.List[str],) -> AccountGetInfoResponse:
    """
...
def account_set_push_settings(
    device_id: str, settings: str, key: str, value: typing.List[str],
) -> OkResponse:
    """
    :param device_id: - Unique device ID.
    :param settings: - Push settings in a [vk.com/dev/push_settings|special format].
...
def database_get_cities_by_id(
    city_ids: typing.List[int],
...
def docs_edit(
    owner_id: int, doc_id: int, title: str, tags: typing.List[str],
) -> OkResponse:
    """
...
def docs_get_by_id(docs: typing.List[str],) -> DocsGetByIdResponse:
    """
...
def fave_get_pages(
    ...
    count: int,
    type: str,
    fields: typing.List[BaseUserGroupFields],
    tag_id: int,
...
def fave_reorder_tags(ids: typing.List[int],) -> OkResponse:
    """
    :param ids:
    :return:
    """
...
def fave_set_page_tags(
    user_id: int, group_id: int, tag_ids: typing.List[int],
) -> OkResponse:
    """
    :param user_id:
    :param group_id:
...
def friends_add_list(name: str, user_ids: typing.List[int],) -> FriendsAddListResponse:
    """
...
def friends_are_friends(
    user_ids: typing.List[int], need_sign: bool,
...
def friends_edit(user_id: int, list_ids: typing.List[int],) -> OkResponse:
    """
...
def friends_edit_list(
    ...
    add_user_ids: typing.List[int],
    delete_user_ids: typing.List[int],
) -> OkResponse:
    """
    :param name: - Name of the friend list.
...
def friends_get_by_phones(
    phones: typing.List[str], fields: typing.List[UsersFields],
...
def groups_edit(
    ...
    market_country: typing.List[int],
    market_city: typing.List[int],
    market_currency: int,
    market_contact: int,
    market_wiki: int,
    obscene_filter: bool,
    obscene_stopwords: bool,
    obscene_words: typing.List[str],
    main_section: int,
...
def groups_get(
    user_id: int,
    extended: bool,
    filter: typing.List[GroupsFilter],
    fields: typing.List[GroupsFields],
    offset: int,
    count: int,
) -> GroupsGetResponse:
    """
...
def groups_get_addresses(
    group_id: int,
    address_ids: typing.List[int],
    latitude: int,
    longitude: int,
    offset: int,
    count: int,
    fields: typing.List[AddressesFields],
...
def groups_get_by_id(
    group_ids: typing.List[str], group_id: str, fields: typing.List[GroupsFields],
...
def groups_get_callback_servers(
    group_id: int, server_ids: typing.List[int],
...
def groups_get_requests(
    group_id: int, offset: int, count: int, fields: typing.List[UsersFields],
...
def groups_is_member(
    group_id: str, user_id: int, user_ids: typing.List[int], extended: bool,
...
def market_add_to_album(
    owner_id: int, item_id: int, album_ids: typing.List[int],
) -> OkResponse:
    """
    :param owner_id: - ID of an item owner community.
...
def market_edit_comment(
    owner_id: int, comment_id: int, message: str, attachments: typing.List[str],
) -> OkResponse:
    """
    :param owner_id: - ID of an item owner community.
    :param comment_id: - Comment ID.
...
def market_get_album_by_id(
    owner_id: int, album_ids: typing.List[int],
...
def market_get_by_id(
    item_ids: typing.List[str], extended: bool,
...
def messages_create_chat(
    user_ids: typing.List[int], title: str,
...
def messages_delete(
    message_ids: typing.List[int], spam: bool, group_id: int, delete_for_all: bool,
...
def messages_get_chat_preview(
    peer_id: int, link: str, fields: typing.List[UsersFields],
...
def messages_get_conversation_members(
    peer_id: int, fields: typing.List[UsersFields], group_id: int,
...
def messages_mark_as_important(
    message_ids: typing.List[int], important: int,
...
def messages_mark_as_read(
    message_ids: typing.List[int], peer_id: int, start_message_id: int, group_id: int,
) -> OkResponse:
    """
...
def messages_search_conversations(
    q: str, count: int, extended: bool, fields: typing.List[UsersFields], group_id: int,
...
def messages_send(
    ...
    attachment: str,
    reply_to: int,
    forward_messages: typing.List[int],
    forward: str,
    sticker_id: int,
    group_id: int,
    keyboard: str,
...
def newsfeed_add_ban(
    user_ids: typing.List[int], group_ids: typing.List[int],
) -> OkResponse:
    """
    :param user_ids:
    :param group_ids:
...
def newsfeed_get(
    filters: typing.List[NewsfeedFilters],
    return_banned: bool,
    start_time: int,
    end_time: int,
    max_photos: int,
...
def newsfeed_get_banned(
    extended: bool, fields: typing.List[UsersFields], name_case: str,
...
def newsfeed_get_comments(
    count: int,
    filters: typing.List[NewsfeedCommentsFilters],
    reposts: str,
    start_time: int,
    end_time: int,
...
def newsfeed_get_lists(
    list_ids: typing.List[int], extended: bool,
...
def newsfeed_get_suggested_sources(
    offset: int, count: int, shuffle: bool, fields: typing.List[BaseUserGroupFields],
...
def newsfeed_save_list(
    list_id: int, title: str, source_ids: typing.List[int], no_reposts: bool,
...
def notes_add(
    title: str,
    text: str,
    privacy_view: typing.List[str],
    privacy_comment: typing.List[str],
) -> NotesAddResponse:
    """
...
def notes_get(
    note_ids: typing.List[int], user_id: int, offset: int, count: int, sort: int,
) -> NotesGetResponse:
    """
...
def notifications_send_message(
    user_ids: typing.List[int], message: str, fragment: str, group_id: int,
...
def orders_get_amount(
    user_id: int, votes: typing.List[str],
...
def orders_get_by_id(
    order_id: int, order_ids: typing.List[int], test_mode: bool,
...
def photos_get_by_id(
    photos: typing.List[str], extended: bool, photo_sizes: bool,
...
def polls_add_vote(
    owner_id: int, poll_id: int, answer_ids: typing.List[int], is_board: bool,
...
def pretty_cards_get_by_id(
    owner_id: int, card_ids: typing.List[int],
...
def secure_get_user_level(user_ids: typing.List[int],) -> SecureGetUserLevelResponse:
    """
    :param user_ids:
    :return:
    """
...
def secure_give_event_sticker(
    user_ids: typing.List[int], achievement_id: int,
...
def secure_send_notification(
    user_ids: typing.List[int], user_id: int, message: str,
...
def secure_set_counter(
    counters: typing.List[str], user_id: int, counter: int, increment: bool,
) -> OkResponse:
    """
    :param counters:
    :param user_id:
...
def storage_get(key: str, keys: typing.List[str], user_id: int, global_: bool,) -> dict:
    """
    :param key:
    :param keys:
    :param user_id:
...
def stories_ban_owner(owners_ids: typing.List[int],) -> OkResponse:
    """
...
def stories_get_banned(
    extended: bool, fields: typing.List[BaseUserGroupFields],
...
def stories_get_by_id(
    stories: typing.List[str], extended: bool, fields: typing.List[BaseUserGroupFields],
...
def stories_unban_owner(owners_ids: typing.List[int],) -> OkResponse:
    """
...
def users_get(
    user_ids: typing.List[str], fields: typing.List[UsersFields], name_case: str,
) -> UsersGetResponse:
    """
...
def video_add_album(
    group_id: int, title: str, privacy: typing.List[str],
...
def video_edit_album(
    group_id: int, album_id: int, title: str, privacy: typing.List[str],
) -> OkResponse:
    """
