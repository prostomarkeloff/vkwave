...
class Account(Category):
    ...
    async def get_counters(
        self, filter: typing.Optional[typing.List[str]] = None, raw: bool = False,
    ...
    async def get_info(
        self, fields: typing.Optional[typing.List[str]] = None, raw: bool = False,
    ...
    async def get_push_settings(
        self, device_id: typing.Optional[str] = None, raw: bool = False,
    ...
    async def set_name_in_menu(
        self, user_id: int = None, name: typing.Optional[str] = None, raw: bool = False,
    ) -> typing.Union[dict, OkResponse]:
        """
    ...
    async def set_offline(self, raw: bool = False,) -> typing.Union[dict, OkResponse]:
        """
        :param raw: - return result at dict
        :return:
        """
    ...
    async def set_online(
        self, voip: typing.Optional[BaseBoolInt] = None, raw: bool = False,
    ) -> typing.Union[dict, OkResponse]:
        """
