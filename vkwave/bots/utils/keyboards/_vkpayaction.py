...
class VKPayActionPayToUser(VKPayAction):
    ...
    def __init__(self, amount: int, user_id: int, description: Optional[str] = None):
        """
        :param amount: the amount of payment in rubles. The minimum value is 1;
        :param user_id:
        :param description: payment description
...
class VKPayActionTransferToGroup(VKPayAction):
    ...
    def __init__(self, group_id: int, description: Optional[str] = None):
        """
        :param group_id:
        :param description: payment description
        """
...
class VKPayActionTransferToUser(VKPayAction):
    ...
    def __init__(self, user_id: int, description: Optional[str] = None):
        """
        :param user_id:
        :param description: payment description
        """
