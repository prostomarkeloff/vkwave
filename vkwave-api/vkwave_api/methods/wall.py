...
class Wall(Category):
    def close_comments(
        self, owner_id: typing.Optional[int], post_id: typing.Optional[int],
    ) -> BaseBoolResponse:
        """
        :param owner_id:
        :param post_id:
    ...
    def create_comment(
        ...
        from_group: typing.Optional[int],
    ...
    def edit(
        ...
        message: typing.Optional[str],
        attachments: typing.Optional[typing.List[str]],
        services: typing.Optional[str],
        signed: typing.Optional[bool],
        publish_date: typing.Optional[int],
        lat: typing.Optional[int],
        long: typing.Optional[int],
        place_id: typing.Optional[int],
        mark_as_ads: typing.Optional[bool],
        close_comments: typing.Optional[bool],
        poster_bkg_id: typing.Optional[int],
        poster_bkg_owner_id: typing.Optional[int],
        poster_bkg_access_hash: typing.Optional[str],
    ) -> WallEditResponse:
        """
        :param owner_id: - User ID or community ID. Use a negative value to designate a community ID.
        :param post_id:
    ...
    def edit_ads_stealth(
        ...
        long: typing.Optional[int],
        place_id: typing.Optional[int],
        link_button: typing.Optional[str],
        link_title: typing.Optional[str],
        link_image: typing.Optional[str],
        link_video: typing.Optional[str],
    ) -> OkResponse:
        """
        :param owner_id: - User ID or community ID. Use a negative value to designate a community ID.
    ...
    def get_by_id(
        self,
        posts: typing.Optional[typing.List[str]],
        extended: typing.Optional[bool],
        copy_history_depth: typing.Optional[int],
        fields: typing.Optional[typing.List[BaseUserGroupFields]],
    ) -> WallGetByIdResponse:
        """
    ...
    def get_comments(
        ...
        fields: typing.Optional[typing.List[BaseUserGroupFields]],
        comment_id: typing.Optional[int],
        thread_items_count: typing.Optional[int],
    ...
    def post(
        ...
        mark_as_ads: typing.Optional[bool],
        close_comments: typing.Optional[bool],
        mute_notifications: typing.Optional[bool],
    ) -> WallPostResponse:
        """
        :param owner_id: - User ID or community ID. Use a negative value to designate a community ID.
    ...
    def search(
        ...
        owners_only: typing.Optional[bool],
        count: typing.Optional[int],
        offset: typing.Optional[int],
        extended: typing.Optional[bool],
        fields: typing.Optional[typing.List[BaseUserGroupFields]],
