...
ErrorHandlerCallable = typing.Callable[[Error, "APIOptionsRequestContext"], typing.Union[typing.Awaitable[None], typing.Awaitable[dict]]]
...
class ErrorDispatcher:
    ...
    async def _run_handler(self, code: int, error: Error, return_info: ReturnInfo, request_context: "APIOptionsRequestContext") -> typing.Union[bool, typing.Optional[dict]]:
    ...
    async def process_error(self, error: Error, request_context: "APIOptionsRequestContext") -> typing.Optional[dict]:
        err = error["error"]
        code = err["error_code"]
